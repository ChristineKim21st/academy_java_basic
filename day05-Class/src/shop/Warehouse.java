...
public class Warehouse {
	//1.멤버 변수(인스턴스변수) 선언부: 제품을 쌓아둘 배열 참조 변수
	Product[] products;
	 ...
	 *검색하여(prodCode 필드가 같으면 같은 제품을 처리)
	...
	private Product findProduct(Product product) {
		...
		for(Product prod: products) {
			...
			//매개변수로 넘겨진 제품 정보(product)와 일치하는지 비교: prodCode만 비교
